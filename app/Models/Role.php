...
class Role extends Model
{
    ...
    public static function semua_akses()
    {
        $data = [
            ...
            // Fitur premium
            'akses_daftar_cabang' => 'Akses Daftar Cabang',
            'akses_tambah_cabang' => 'Akses Tambah Cabang',
            'akses_edit_cabang' => 'Akses Edit Cabang',
            'akses_hapus_cabang' => 'Akses Hapus Cabang',
